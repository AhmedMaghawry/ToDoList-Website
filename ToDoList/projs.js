...
function removeAlltasks(index){
    if (alltaskslist[index].state=="In Progress"){
        inProgresslist.splice(index,1);
        inprogress--;
    }
    else if (alltaskslist[index-1].state=="Done"){
        donelist.splice(index-1,1);
        done--;
    }
    else if (alltaskslist[index-1].state=="Archived"){
        archived.splice(index-1,1);
        arch--;
    }
    alltaskslist.splice(index-1,1);
    alltasks--;
    drawAllTasksTable();
};
